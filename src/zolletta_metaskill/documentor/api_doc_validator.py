...
def main():
    ...
    # Validate
    issues, suggestions = validate_api_docs(source_sigs, documented_items)

    # Report
    report = generate_report(
        issues, suggestions, source_count, doc_count,
        as_json=args.json, suggest_coverage=args.suggest_coverage,
    )
    print(report)

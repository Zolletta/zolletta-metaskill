"""Tests for companion_skill_detector.py."""
...
class TestDetectCompanionSkills:
    ...
    def test_detect_companion_skills_both_installed_returns_true(self, tmp_path: Path) -> None:
        php_pro = tmp_path / "php-pro" / "SKILL.md"
        python_dev = tmp_path / "python-development" / "SKILL.md"
...
class TestMain:
    ...
    def test_main_prints_json(
        ...
        rc = CompanionSkillDetector.main()

...
- **`reference/tool-messages.md`** — shared "not installed" message for tokensave, explaining why zolletta benefits from the tool with homepage link, used by both setup and the tool-failure handler

...
> This file narrows down any eventual general rule about Python, i.e. `~/.agents/python-rules.md`. If you have rules in `~/.agents/`, those are the single source of truth for their domain.

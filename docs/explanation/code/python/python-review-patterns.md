...
> This file narrows down any eventual general rule about Python, i.e. `python-rules.md`. If you maintain rules as part of your agent configuration, those are the single source of truth for their domain.

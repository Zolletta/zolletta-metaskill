...
| `max_file_length`                | integer | `300`   | Structure  | Maximum allowed lines per file (enforced by `file_length_scanner.py`) |
...
| `max_file_length`             | integer | `300`   | Structure   | Maximum allowed lines per file (enforced by `file_length_scanner.py`) | all     |

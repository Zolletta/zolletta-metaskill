...
| File                                                         | Score | Label     |
|--------------------------------------------------------------|-------|-----------|
| `skills/zolletta-metaskill-review/assets/summary_template.md`                   | 29.1  | abandoned |
| `skills/zolletta-metaskill-review/assets/todo_template.md`                      | 29.1  | abandoned |
| `docs/adr/adr-distilled.md`                                  | 31.2  | critical  |
| `skills/zolletta-metaskill-python-code-style/SUBSKILL.md`                          | 45.2  | critical  |
| `docs/adr/0009-inline-shell-replaced-with-python-scripts.md` | 46.2  | critical  |
| `skills/zolletta-metaskill-patterns/SUBSKILL.md`                                   | 48.2  | critical  |
| `skills/zolletta-metaskill-review/SUBSKILL.md`                                     | 48.5  | critical  |
| `skills/zolletta-metaskill-php-testing-style/SUBSKILL.md`                          | 48.6  | critical  |
| `skills/zolletta-metaskill-python-testing-style/SUBSKILL.md`                       | 50.0  | critical  |
...
| File                                       | Issue                                        | Category | Fix Type |
|--------------------------------------------|----------------------------------------------|----------|----------|
| `skills/zolletta-metaskill-review/assets/summary_template.md` | 427 code files changed, no source references | factual  | Manual   |
| `skills/zolletta-metaskill-review/assets/todo_template.md`    | 427 code files changed, no source references | factual  | Manual   |
...
_Generated by [zolletta-metaskill documentor](https://github.com/Zolletta/zolletta-metaskill/tree/main/skills/zolletta-metaskill-documentor/SUBSKILL.md)_

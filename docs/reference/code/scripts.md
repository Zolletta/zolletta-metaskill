...
```bash
python3 src/zolletta_metaskill/scanners/scan_acronym_casing.py <directory> [--acronyms <list>] [--strict] [--json] [--skip]
```
...
```bash
python3 src/zolletta_metaskill/scanners/test_splitter.py <test_file> [--dry-run] [--output-dir <dir>]
```

...
General skills (patterns, documentor) always run. Language-specific skills (python-code-style, python-testing-patterns, php-code-style, php-testing-patterns) run only when the project uses the matching language.

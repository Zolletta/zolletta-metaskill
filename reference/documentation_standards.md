...
> This file narrows down any eventual general rule about documentation, i.e. [rules/documentation-rules.md](../rules/documentation-rules.md). All files in `rules/` are the single source of truth for their domain.
